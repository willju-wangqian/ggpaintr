...
description: Run an autonomous publication-readiness / CRAN-prep improvement loop for the ggpaintr repository. Use when the user wants Codex to run the stored assessment prompt in dev/tasks/publication-readiness-cran-prep-prompt.md, turn findings into concrete plans, implement the fixes, delegate independent batches to subagents, and rerun the assessment after major updates until substantive requirements are addressed.
---
...
1. `CLAUDE.md`
2. `.claude/knowledge/project-overview.md`
3. `dev/tasks/publication-readiness-cran-prep-prompt.md`
...
Read `.claude/knowledge/testing-strategy.md` whenever the batch changes
