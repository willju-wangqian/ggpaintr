...
library(shiny)
# EXCEPT: NOT vignette-paired -- ADR 0025 §4 / PLAN-04. The formula has
# NO ppUpload anywhere; the code panel must NOT emit a prologue line.
ptr_app(
  "mtcars |> ggplot(aes(x = ppVar('mpg'))) + geom_point()"
)
