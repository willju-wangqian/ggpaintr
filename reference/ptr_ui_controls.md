...
#> </div>
#> <div class="tabbable">
#>   <ul class="nav nav-hidden shiny-tab-input" id="p-ptr_layer_tabset" data-tabsetid="6980">
#>     <li class="active">
#>       <a href="#tab-6980-1" data-toggle="tab" data-bs-toggle="tab" data-value="ggplot">ggplot</a>
#>     </li>
#>     <li>
#>       <a href="#tab-6980-2" data-toggle="tab" data-bs-toggle="tab" data-value="geom_point">geom_point</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="6980">
#>     <div class="tab-pane active" data-value="ggplot" id="tab-6980-1">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="geom_point" id="tab-6980-2">
#>       <div class="form-group shiny-input-container">
#>         <div class="checkbox">
#>           <label>
...
#> </div>
#> <div class="tabbable">
#>   <ul class="nav nav-hidden shiny-tab-input" id="p-ptr_layer_tabset" data-tabsetid="8132">
#>     <li class="active">
#>       <a href="#tab-8132-1" data-toggle="tab" data-bs-toggle="tab" data-value="ggplot">ggplot</a>
#>     </li>
#>     <li>
#>       <a href="#tab-8132-2" data-toggle="tab" data-bs-toggle="tab" data-value="geom_point">geom_point</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="8132">
#>     <div class="tab-pane active" data-value="ggplot" id="tab-8132-1">
#>       <div id="p-ptr_layer_content_ggplot" class="ptr-layer-content">
#>         <div id="p-ggplot_1_1_ppVar_NA_ui" class="shiny-html-output"></div>
#>         <div id="p-ggplot_1_2_ppVar_NA_ui" class="shiny-html-output"></div>
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="geom_point" id="tab-8132-2">
#>       <div class="form-group shiny-input-container">
#>         <div class="checkbox">
#>           <label>
#>             <input id="p-geom_point_checkbox" type="checkbox" class="shiny-input-checkbox" checked="checked"/>
