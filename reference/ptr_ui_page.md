...
#>           </div>
#>           <div class="tabbable">
#>             <ul class="nav nav-hidden shiny-tab-input" id="p-ptr_layer_tabset" data-tabsetid="7628">
#>               <li class="active">
#>                 <a href="#tab-7628-1" data-toggle="tab" data-bs-toggle="tab" data-value="ggplot">ggplot</a>
#>               </li>
#>               <li>
#>                 <a href="#tab-7628-2" data-toggle="tab" data-bs-toggle="tab" data-value="geom_point">geom_point</a>
#>               </li>
#>             </ul>
#>             <div class="tab-content" data-tabsetid="7628">
#>               <div class="tab-pane active" data-value="ggplot" id="tab-7628-1">
...
#>                 </div>
#>               </div>
#>               <div class="tab-pane" data-value="geom_point" id="tab-7628-2">
#>                 <div class="form-group shiny-input-container">
#>                   <div class="checkbox">
#>                     <label>
