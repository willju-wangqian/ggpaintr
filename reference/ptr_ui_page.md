...
#>           </div>
#>           <div class="tabbable">
#>             <ul class="nav nav-hidden shiny-tab-input" id="p-ptr_layer_tabset" data-tabsetid="9459">
#>               <li class="active">
#>                 <a href="#tab-9459-1" data-toggle="tab" data-bs-toggle="tab" data-value="ggplot">ggplot</a>
#>               </li>
#>               <li>
#>                 <a href="#tab-9459-2" data-toggle="tab" data-bs-toggle="tab" data-value="geom_point">geom_point</a>
#>               </li>
#>             </ul>
#>             <div class="tab-content" data-tabsetid="9459">
#>               <div class="tab-pane active" data-value="ggplot" id="tab-9459-1">
...
#>                 </div>
#>               </div>
#>               <div class="tab-pane" data-value="geom_point" id="tab-9459-2">
#>                 <div class="form-group shiny-input-container">
#>                   <div class="checkbox">
#>                     <label>
