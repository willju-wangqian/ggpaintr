...
<!-- Generated by /workflow init — edit values as needed -->
...
These workflows are available via `/workflow <name>`:
...
- `fact-check` — cross-validate docs against source code (replaces "fact-check docs" prompt contract)
- `knowledge-update` — update CLAUDE.md and memory files (replaces "update knowledge" prompt contract)
- `clean-up` — test, check, build docs, update knowledge (replaces "clean up repo" prompt contract)
