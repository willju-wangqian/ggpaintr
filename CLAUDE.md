...
2. Grep for file/directory path references, verify they exist on disk
3. Verify CLAUDE.md dependency list matches DESCRIPTION Imports
4. Verify return-value descriptions match source code
5. Report mismatches, then fix with source-code-backed corrections
