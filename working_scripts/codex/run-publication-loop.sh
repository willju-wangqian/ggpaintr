...
RUN_DIR="${CODEX_LOOP_RUN_DIR:-$ROOT_DIR/working_scripts/codex/runs/$STAMP}"
PROMPT_TEMPLATE="${CODEX_LOOP_PROMPT_TEMPLATE:-$ROOT_DIR/working_scripts/codex/publication-loop-prompt.md}"
SCHEMA_FILE="${CODEX_LOOP_SCHEMA_FILE:-$ROOT_DIR/working_scripts/codex/publication-loop-schema.json}"
