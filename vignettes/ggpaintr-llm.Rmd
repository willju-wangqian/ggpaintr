...
| `level2_embed`           | Embed ggpaintr inside the user's own Shiny app (module + split paths).   |
| `level2_custom_ids`      | Id collisions, the `ptr_` reserved prefix, generated-id grammar.         |
| `level2_namespacing`     | Multiple ggpaintr instances + cross-instance shared widgets.             |
